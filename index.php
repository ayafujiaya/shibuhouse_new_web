      ...
      <div id="hot_topics">
        ...
        <div id="hot_topics_text">
          <ul>
            ...
            <li class="topics"><sep class="topics_date">　　　 2013/12/05</sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[NEWS]   <a href="http://j-mediaarts.jp/awards/recommends?locale=ja&section_id=2" target="_blank">12/05（木）エキソニモ/渋家/Maltine Records「第17回 文化庁メディア芸術祭」審査委員会推薦作品選出</a></sep></li>
            <li class="topics"><sep class="topics_date">　　　 2013/12/04</sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[MEMBER] <a href="https://www.facebook.com/events/560368644051891/" target="_blank">12/10（火）齋藤桂太 西田篤史「Bar齋藤篤史」（歌舞伎町はな）店長</a></sep></li>
            ...
            <li class="topics"><sep class="topics_date">　　　 2013/11/29</sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[EVENT] <a href="http://golden-maximum-fantastic-extream.tumblr.com/" target="_blank">12/22（日）「渋家ゴールデンマキシマムファンタスティックエクストリームホームパーティー」（風林会館）主催</a></sep></li>
            ...
            <li class="topics"><sep class="topics_date">　　　 2013/11/29</sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[NEWS]  <a href="http://great-saito.jimdo.com/" target="_blank">11/22（金）「渋家」代表交代 6代目代表に齋藤桂太が就任</a></sep></li>
          </ul>
        </div><!-- hot_topics_text -->
      </div><!-- #hot_topics -->
      <div id="content">
