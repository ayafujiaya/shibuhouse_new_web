    ...
    <div id="wrap">
      ...
      <div id="hot_topics">
        ...
        <div id="hot_topics_text">
          <ul>
            <li class="topics"><sep class="topics_date">[NEW] 2013/12/12</sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[MEMBER] <a href="./shibu_e/bourei.html" target="_blank">12/22（日）「渋家脱出ゲーム」公演</a></sep></li>
