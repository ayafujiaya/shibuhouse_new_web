    ...
    <div id="wrap">
      <?php require './header.php' ?>
        ...
        <div class="flexslider">
          <ul class="slides">
            <li><a target="_blank" href="./shibu_e/bourei.html"><img src="./img/topimage/top_bourei.png"></a></li>
      ...
      <div id="hot_topics">
        ...
        <div id="hot_topics_text">
          <ul>
            <li class="topics"><sep class="topics_date">[NEW] </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[EVENT] <a href="http://j-mediaarts.jp/awards/recommends?locale=ja&section_id=2" target="_blank">02/05（水）-02/16（日）エキソニモ/渋家/Maltine Records「第17回 文化庁メディア芸術祭」（国立新美術館）展示</a></sep></li>
            <li class="topics"><sep class="topics_date">[NEW] </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[EVENT] <a href="http://jmaf-promote.jp/global/18.html" target="_blank">01/29（水）-02/02（日）エキソニモ/渋家/Maltine Records「トランスメディアーレ2014」（Germany）展示</a></sep></li>
            <li class="topics"><sep class="topics_date">[NEW] </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[EVENT] <a href="http://www.loft-prj.co.jp/schedule/naked/20614" target="_blank">01/08（水）齋藤桂太 西田篤史「シェアハウスとは何だったのか？ 脱法ハウス問題と無縁化する社会」（Naked Loft）出演</a></sep></li>
            <li class="topics"><sep class="topics_date">[NEW] </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[MEMBER] <a href="http://bisyoku-vansankai.info/" target="_blank">12/29（日）岡村飛龍「美食晩餐会」参加</a></sep></li>
            <li class="topics"><sep class="topics_date">[NEW] </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[EVENT] <a href="./shibu_e/bourei.html" target="_blank">12/22（日）「渋家脱出ゲーム」（風林会館）公演</a></sep></li>
            ...
            <li class="topics"><sep class="topics_date">　　　 </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[ART]   <a href="http://ca-mp.blogspot.jp/" target="_blank">12/21（土）CAMP主催イベント「現在のアート＜2013＞」（森美術館）出演</a></sep></li>
