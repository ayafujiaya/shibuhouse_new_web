    ...
    <div id="wrap">
      ...
      <div id="hot_topics">
        ...
        <div id="hot_topics_text">
          <ul>
            <li class="topics"><sep class="topics_date">2013/12/02</sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[ART]   <a href="http://the-container.com/" target="_blank">12/02（月）グループ展「Multi(Multi)(ple(s))」（The Container）参加</a></sep></li>
