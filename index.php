      ...
      <div id="hot_topics">
        ...
        <div id="hot_topics_text">
          <ul>
            ...
            <li class="topics_new"><sep class="topics_date">[NEW] </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[MEMBER] <a href="https://www.facebook.com/events/1430024563901547/?ref_dashboard_filter=upcoming" target="_blank">02/11（火）増沢大輝 金藤みなみ「ファウンデーション」（としまアートステーションZ）出演</a></sep></li>
            ...
            <li class="topics_new"><sep class="topics_date">[NEW] </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[MEMBER] <a href="http://www.youtube.com/watch?v=JYiDrjfiq3c&feature=youtu.be" target="_blank">02/06（木）ちゃんもも◎「VICE Eats With...ちゃんもも」（VICE Japan）動画公開</a></sep></li>
