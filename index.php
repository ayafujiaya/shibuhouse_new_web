      ...
      <div id="hot_topics">
        ...
        <div id="hot_topics_text">
          <ul>
            ...
            <li class="topics"><sep class="topics_date">[NEW] </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[MEMBER] <a href="http://www.geocities.jp/azabubu/s12/" target="_blank">01/07（火）木皮成 増沢大輝「ダンスがみたい！新人シリーズ12」（日暮里d-倉庫）出演</a></sep></li>
            ...
            <li class="topics"><sep class="topics_date">　　　 </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[MEMBER] <a href="http://www.jackemedia.co.jp/kera/" target="_blank">12/16（月）ちゃんもも◎ 連載記事掲載『KERA』（2月号）発売</a></sep></li>
