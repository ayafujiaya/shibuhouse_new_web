      ...
      <div id="hot_topics">
        ...
        <div id="hot_topics_text">
          <ul>
            ...
            <li class="topics_new"><sep class="topics_date">　　　 </sep><img class="arrow" src="./img/arrow.png"><sep class="topics_date">[MEMBER] <a href="http://kentacobayashi.com/" target="_blank">01/11（土）- 02/28（金）小林健太 グループ展「THE EXPOSED #7」（G/P＋g3/ gallery）出展</a></sep></li>
