		...
		<div id="wrap">
			<?php require './header.php' ?>
				...
				<div id="what" class="midashi">
					...
					<div class="midashi_text">
						現在の渋家は、渋家の内部から外部へさまざななコンテンツやプロジェクトを持ち出すことをテーマとして、コミュニティマネジメント、イベントオーガナイズ、アートインキュベーションを３つの柱として活動しています。<br>
具体的には、コミュニティマネジメントでは、代表の齋藤桂太が NHK「ニッポンのジレンマ」に出演するなど、新たなコミュニティのプロトタイプとして渋家が評価されたことを受け、これまであまり表に出さなかった生活コンテンツの公開やアーカイブ化を進めています。<br>
次に、イベントオーガナイズは、より多くの人と関わることを目的として、イベントの主催や出演を積極的に行っており、毎月22日に開催している「渋家ホームパーティ」を外に拡大させた400人参加のイベントを開催するなど規模を拡大させています。<br>
また、アート方面では、森美術館「六本木クロッシング展」のなかで「全国のディスカーシブ・プラットホーム」として選出されたことを受け、アーティストメンバーが中心となり、外部の人間も参加可能な“対話の場”である「Shibuhouse Art Secret Meeting」の発足を準備しています。<br>
